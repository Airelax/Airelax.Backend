...
namespace Airelax.Controllers
{
    ...
    {
        private readonly MemberInfoRepository _memberInfoRepository;
        private readonly AirelaxContext _context;

        public MemberInfoController(AirelaxContext context, MemberInfoRepository memberInfoRepository)
        {
            _context = context;
